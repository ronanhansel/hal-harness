...
try:
    ...
    def get_trapi_client():
        ...
        if prefetched_token:
            print(f"[LiteLlmEngine] Using pre-fetched Azure AD token")
            return AzureOpenAI(
        ...
        try:
            ...
            if os.path.exists(cache_path):
                ...
                if accounts:
                    ...
                    # Test it works
                    token_provider()
                    print(f"[LiteLlmEngine] Using MSAL token provider")
                    return AzureOpenAI(
                        azure_endpoint=endpoint,
            ...
            print(f"[LiteLlmEngine] MSAL fallback failed: {e}")
        ...
        try:
            ...
            print(f"[LiteLlmEngine] Using AzureCliCredential")
            return AzureOpenAI(
                azure_endpoint=endpoint,
                azure_ad_token_provider=token_provider,
                api_version=api_version,
